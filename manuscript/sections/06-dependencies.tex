...
\begin{figure}[H]
\centering\resizebox{\textwidth}{!}{\input{figures/dependency-threat}}
\caption{Simplified object dependency and attack-propagation path. Red dashed arrows describe a possible causal path, not proof that every anomaly is malicious.\label{fig:dependency}}
\end{figure}
