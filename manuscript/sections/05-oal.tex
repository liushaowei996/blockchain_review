...
\caption{The authors' OAL framework. The cross-cutting plane carries mechanisms and versioned governance artifacts across all object, assurance, and lifecycle cells.\label{fig:oal}}
\end{figure}
