...
\vspace{6pt}
\supplementary{The following supporting information accompanies the submission: Table S1, the reference inventory and analytical fields (CSV); Supplementary Note S3, supporting evidence and source locators (Markdown); and the publication figure files for Figures 1--7 (PDF).}
...
\dataavailability{The cited publications, reference inventory, and supplementary source notes provide the evidence for the comparisons in this review. The source notes identify supporting findings, assumptions, and page or section references.}
