...
\vspace{6pt}
\supplementary{The following supporting information accompanies the submission: Table S1, the internal evidence matrix (CSV); Table S2, the lawful full-text acquisition manifest (CSV); and the editable vector source for Figures 1--7 (TikZ/LaTeX).}
